...
MiddleRect = CenterRectOnPoint(feedbackRect,centerhoriz,centervert);

[imagename, ~, ~] = imread(fullfile(maindir,'imgs','reward.png'));
reward_texture = Screen('MakeTexture', mywindow, imagename);
[imagename, ~, ~] = imread(fullfile(maindir,'imgs', 'no_reward.png'));
no_reward_texture = Screen('MakeTexture', mywindow, imagename);
